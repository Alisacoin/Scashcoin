...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x70e;
...
const uint32_t UPGRADE_HEIGHT_V2                             = 20000;
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "blocks.Alisa";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "blockindexes.Alisa";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "poolstate.Alisa";
const char     P2P_NET_DATA_FILENAME[]                       = "p2pstate.Alisa";
const char     MINER_CONFIG_FILE_NAME[]                      = "miner_conf.Alisa.json";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "Coin";
const char GENESIS_COINBASE_TX_HEX[]                         = "013c1ff0001ffffffffffff0f029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101a5d2baed175e1b5b858d5ab99a959e0926ab383e3f0bfca6283fb0a5bfaff37e";
